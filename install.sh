...
BINARY_NAME=${BINARY_NAME:-"treblle"}

REPO_NAME="treblle/treblle-cli"
ISSUE_URL="https://github.com/treblle/treblle-cli/issues/new"

# get_latest_release "treblle/treblle-cli"
get_latest_release() {
...
get_asset_name() {
  echo "treblle_$1_$2.zip"
}

get_download_url() {
  local asset_name=$(get_asset_name $2 $3)
  echo "https://github.com/treblle/treblle-cli/releases/download/v$1/${asset_name}"
}

get_checksum_url() {
  echo "https://github.com/treblle/treblle-cli/releases/download/v$1/checksums.txt"
}
...
do_install_binary() {
  ...
  echo "Installed treblle to $INSTALL_DIR"
...
$
             ...
             The Treblle CLI is now Installed!
 
   Run `treblle help` for a list of commands.
EOF
  printf "$RESET"
